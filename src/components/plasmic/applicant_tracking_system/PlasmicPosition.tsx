...
import Card from "../../Card"; // plasmic-import: sY32wV_vsiKf/component
...
import sty from "./PlasmicPosition.module.css"; // plasmic-import: hbIgkik0YHEp/css
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    position: usePlasmicDataOp(() => {
      return {
        ...
        opId: "9d25997a-792f-47e8-a4e2-583d0e56f309",
        userArgs: {
          filters: [$ctx.params.id]
        },
        cacheKey: `plasmic.$.9d25997a-792f-47e8-a4e2-583d0e56f309.$.`,
    ...
    candidates: usePlasmicDataOp(() => {
      return {
        sourceId: "dSeMFUEQKWYRmZyZcQURZH",
        opId: "eb414b5f-7282-4d4e-9330-2d017ac07195",
        userArgs: {
          filters: [$ctx.params.id]
        },
        cacheKey: `plasmic.$.eb414b5f-7282-4d4e-9330-2d017ac07195.$.`,
        invalidatedKeys: null,
        roleId: "0460580e-cda3-4d2e-afe5-621ccb21caca"
      };
    })
            ...
            <DataCtxReader__>
              {$ctx => (
                ...
                >
                        ...
                        $steps["tutorialdbUpdateMany"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "dSeMFUEQKWYRmZyZcQURZH",
                                  opId: "46f9320d-53a1-4550-a625-c164a835819e",
                                  userArgs: {
                  ...
                  <Card
                    className={classNames("__wab_instance", sty.card__dnxlr)}
                    noTitle={true}
                  >
                    <RichDetails
                  ...
                  <Card
                    className={classNames("__wab_instance", sty.card__jIabk)}
                    title={
                      <h4
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicPosition__VariantsArgs, ReservedPropsType> &
