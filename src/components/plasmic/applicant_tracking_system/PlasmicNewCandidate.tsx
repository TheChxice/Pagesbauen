...
import sty from "./PlasmicNewCandidate.module.css"; // plasmic-import: Am52ApLwPCxC/css
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    positions: usePlasmicDataOp(() => {
      return {
        ...
        opId: "d0f502df-d6fc-4816-80fa-086a0e6e4e97",
        userArgs: {},
        cacheKey: `plasmic.$.d0f502df-d6fc-4816-80fa-086a0e6e4e97.$.`,
                        ...
                        $steps["postgresCreate"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "dSeMFUEQKWYRmZyZcQURZH",
                                  opId: "b3c56126-36a0-4679-9b13-ca67a4f31cb0",
                                  userArgs: {},
                                  cacheKey: null,
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicNewCandidate__VariantsArgs, ReservedPropsType> &
