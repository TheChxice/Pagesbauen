...
// Typ für einzelne Frage eines Duells
type QuestionResult = {
    question: string;
    ...
    return (
        <Box p={6} minH="100vh" bg="gray.50">
            ...
            <Flex gap={4} mb={6}>
                ...
                <Button
                    colorScheme={filter === "win" ? "green" : "gray"}
                    onClick={() => setFilter("win")}
                >
                    Siege
                </Button>
                <Button
                    colorScheme={filter === "lose" ? "red" : "gray"}
                    ...
                    return (
                        ...
                        >
                            <Flex justify="space-between" align="center" mb={2}>
                                ...
                                <Badge colorScheme={isWin ? "green" : "red"}>
                            ...
                            {/* Mini-Häkchen/Kreuze pro Frage */}
                            <HStack spacing={1}>
                                {duel.results.map((res, idx) =>
                                    res.isCorrect ? (
                                        <CheckIcon key={idx} color="green.500" />
                                    ) : (
                                        <CloseIcon key={idx} color="red.500" />
                                    )
                                )}
                            </HStack>
                        </Box>
                        ...
                        <ModalBody>
                            ...
                            <Flex justify="space-between" mt={4}>
                                <Text fontWeight="bold">
                                    Punkte: Anna Schmidt {selectedDuel.scores["Anna Schmidt"]} |{" "}
                                    {selectedDuel.opponent} {selectedDuel.scores[selectedDuel.opponent]}
                                </Text>
